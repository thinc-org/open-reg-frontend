...
class ApiService extends __BaseService {
  ...
  getFormAllResponse(): __Observable<
    __StrictHttpResponse<Array<FormResponse>>
  > {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
  ...
  getChulaSsoValidateTicketResponse(
    ticket: string
  ): __Observable<__StrictHttpResponse<ValidateTicketResponse>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @param ticket undefined
   */
  getChulaSsoValidateTicket(
    ticket: string
  ): __Observable<ValidateTicketResponse> {
  ...
  getExportCsvId(id: string): __Observable<null> {
    return this.getExportCsvIdResponse(id).pipe(__map(_r => _r.body as null));
  }
}
